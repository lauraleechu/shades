...
summary |>
  kable(caption = "Table 1: Total number of products by lightness range in India & Japan") |>
...
brand_origin |>
  ...
  labs(x = "Country",
    y = "Lightness",
    title = "Fig. 1: Shade Distribution by Lightness: Domestic vs. International Brands",
    color = "Country",
...
brand_origin |>
  ...
  labs(x = "Country",
    y = "Saturation",
    color = "Country",
    title = "Fig. 2: Shade Distribution by Saturation: Domestic vs. International Brands",
    caption = "Data source: The Pudding") 
...
kbl(summary, caption = "Table 2: Linear Regression Model Summary") |>
...
brand_origin |>
  ...
  theme_minimal() +
   labs(x = "Lightness",
    y = "Saturation",
    title = "Fig. 4: Relationship between Lightness and Saturation in Shades in Japan",
    caption = "Data source: The Pudding") 
...
brand_origin |>
  ...
  theme_minimal() +
   labs(x = "Lightness",
    y = "Saturation", 
    title = "Fig. 5: Relationship between Lightness and Saturation in Shades in India",
    caption = "Data source: The Pudding") 
